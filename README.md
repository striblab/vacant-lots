...
```html
<div data-pym-src="http://static.startribune.com/projects/vacant-lots">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/vacant-lots/",
      "url": "http://static.startribune.com/news/projects-staging/all/vacant-lots/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/vacant-lots/",
      "url": "http://static.startribune.com/news/projects/all/vacant-lots/"
    }
  }
}
```
